document.addEventListener('DOMContentLoaded', () => {
    ...
    const fadeElements = document.querySelectorAll('.fade-in-up, .info-step, .info-card, .nuclear-intro-card, .energy-card, .plant-card, .pro-card, .con-card, .barrier-card, .waste-step, .history-card, .impact-card, .lab-section-block, .prop-card, .recommendation-card, .chart-row, .key-finding-box, .academic-text');
